...
- `OPENROUTER_API_KEY` — из https://openrouter.ai/keys
- `OPENROUTER_MODEL` — модель из каталога https://openrouter.ai/models
...
5. В разделе Environment добавьте `OPENROUTER_API_KEY`, `OPENROUTER_MODEL`
   и `WEBHOOK_SECRET`.
